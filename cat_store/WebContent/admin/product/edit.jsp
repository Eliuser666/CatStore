...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/EditProductServlet" method="post" enctype="multipart/form-data">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="is_hot">
							...
							<option value="0" <c:if test="${p.is_hot==0}">selected</c:if>>否</option>
						</select>
					</td>
				</tr>
				<tr>
