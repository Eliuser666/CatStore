...
import com.catstore.domain.Cart;
import com.catstore.domain.CartItem;
...
import com.catstore.service.impl.OrderServiceImpl;
import com.catstore.utils.BaseServlet;
import com.catstore.utils.BeanFactory;
import com.catstore.utils.PaymentUtil;
...
public class OrderServlet extends BaseServlet {
	...
	public String payOrder(HttpServletRequest req, HttpServletResponse resp) {
		try {
			...
			String p6_Pcat = "";
			String p7_Pdesc = "";
			String p8_Url = "http://localhost:8080/cat_store/OrderServlet?method=callBack";
			String p9_SAF = "";
			String pa_MP = "";
	...
	public String callBack(HttpServletRequest req, HttpServletResponse resp) {
		try {
			...
			/*
			 * req.setAttribute("oid", oid); req.setAttribute("money", money);
			 */
